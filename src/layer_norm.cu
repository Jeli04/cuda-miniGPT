...
//     const float* h_input = loadMatrix(block_size, d_model, file);
//     float* d_input;
...
//     float* h_gamma = loadMatrix(d_model, 1, source);
//     float* d_gamma;
...
//     source = folder + file;
//     float* h_beta = loadMatrix(d_model, 1, source); 
//     float* d_beta;
